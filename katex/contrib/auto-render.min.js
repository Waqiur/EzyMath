    ...
    return (function (e) {
        ...
        function (e, t, r) {
            ...
            var n = r(0),
                    ...
                    for (var o = [], i = 0; i < e.length; i++)
                        if ("text" === e[i].type) {
                            var l = e[i].data,
                                ...
                                s = 0,
                                f = void 0;
                            for (-1 !== (f = l.indexOf(t)) && ((s = f), o.push({ type: "text", data: l.slice(0, s) }), (d = !1)); ;) {
                                if (d) {
                                    if (-1 === (f = l.indexOf(t, s))) break;
                                    o.push({ type: "text", data: l.slice(s, f) }), (s = f);
                                } else {
                                    if (-1 === (f = a(r, l, s + t.length))) break;
                                    o.push({ type: "math", data: l.slice(s + t.length, f), rawData: l.slice(s, f + r.length), display: n }), (s = f + r.length);
                                }
                                d = !d;
                            }
                ...
                l = function (e, t) {
                    var r = (function (e, t) {
                        for (var r = [{ type: "text", data: e }], n = 0; n < t.length; n++) {
                            var o = t[n];
                    ...
                    for (var n = document.createDocumentFragment(), a = 0; a < r.length; a++)
